...
SortedListPtr SLCreate(CompareFuncT cf, void* );
...
//find and remove single node, free()
//
...
//when we create, points to first spot. Call SLnextItem which returns value of first pointer
//once we call SLnextItem to return value, move iterator to next Item
